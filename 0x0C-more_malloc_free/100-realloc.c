 ...
 * If ptr is NULL, then the call ==  malloc(new_size)...
 * ...for all values of old_size and new_size
 * If new_size = zero, ptr != NULL, then the call is == free(ptr). Return NULL
 ...
 * @ptr: pointer memory allocated prior with a call to malloc: malloc(old_size)
 * @old_size: is the size, in bytes, of the allocated space for ptr
 * @new_size: the new size, in bytes of the new memory block
 * Return: a pointer to the reallocated block of memory. NULL (see above).
 */
